...
//キーボードデータ構造体
const DIDATAFORMAT keybord =
{ 24, 16, DIDF_RELAXIS, 256, 256, &keybordTbl[0] };


//ジョイパッドテーブル
static DIOBJECTDATAFORMAT joypadTbl[] =
{
...
//ジョイパッドデータ構造体
const DIDATAFORMAT joypad =
{ 24, 16, DIDF_ABSAXIS, 80, 44, &joypadTbl[0] };